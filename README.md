...
To run any of the .py files:

1. Enter the main directory of the project

2. Create a python virtual environment

3. Download the requirements from the requirements.txt file
